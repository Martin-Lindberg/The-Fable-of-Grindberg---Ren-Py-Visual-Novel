...
label start:
    ...
    b "Han var den snällaste kung som någonsin hade existerat."

    b "Han kände ett stort ansvar som konung och såg alltid till att alla på KG var lyckliga."
    ...
    b "Varför han hjälpte Sam var oklart. Han kanske betalade vidar i cigg."
    ...
    b "Mårten var Kung Simons rådgivare och alltiallo och Victor var juridiskt ombud och Mårtens 'pojkvän'."

    b "De hade endast ögon för varandra, men när kungen harklade sig vände sig båda mot honom med breda léenden."

    vic "-O store och ärade konung! Vad roligt att se er!"

    m "-Vårt rike blomstrar, bänken är nyoljad och folket älskar er, ers höghet."
    ...
    mvic "-AssåhardusettGravitydetärjutypdenbästafilmensomnågonsinhargjortsherregudjagdör!!!"
    ...
    b "Nu har du ett val att göra."

    b "Antingen får du se hur Kung Grindberg ska lösa sin brist på filmtrivia."

    b "Eller så får du se vad Mårten hittar på för skit."
    ...
    label choice_grindberg:
        ...
        label choice1_no:
            ...
            b "Vidar såg upp på Grindberg med en blick som han aldrig hade sett förut."

            b "Den annars så slappa blicken som vittnade om hur lite Vidar sov och hur mycket gräs han rökte hade bytts ut mot en målmedveten och intensiv blick."

            b "Simon blev ställd. Han var inte bekväm med vad han såg framför sig, det var för mycket att smälta."

            g "-Eeeh."

            g "Jag ska nog gå hem nu."

            b "Vidar såg plötsligt likgiltig ut."
            ...
            b "Simon såg efter Vidar."

            b "Hade han verkligen gjort rätt val?"

            b "Det var dock försent att ångra sig nu, han drog ett sista bloss av sin cigarett och vandrade sedan hemåt."
    ...
    label choice_mårten:
        ...
        m "Så sant, så sant, min karambit-älskande vän."
    ...
    m "{size=-10} -Asså bror, se Gravity, det är det bästa som hänt sen skivat bröd."
    ...
    b "Mårten stod ensam kvar med en snopen min."

    b "Han oroade sig för sin konung."

    b "Aldrig brukade han aldrig bete sig såhär."
    ...
    b "Känslan var magisk, det här kunde inte ens mäta sig med att få en 360 no-scope."

    b "Till slut orkade ingen av dem mer och med svetten rinnandes längs ryggen tog de en powernap i varandras armar."
    ...
    m "-men jag hann! JAG HANN! WOOOOOOOOOOOOOOAAAAAAAAAAA!!!"
    ...
    br "-Ich accepterar inget füsk eller dåliga svaren."
    ...
    br "-ünt minuspoängen när ni svaren in den Wald!"
    ...
    br "-LÅS! Här ställs inga frågor! Ich ställer frågorna!"
    ...
    br "-NEIN NEIN NEIN NEIN NEIN NEIN NEIN NEIN NEIN!!!!"
    ...
    br "-Vem skrev müsiken i filmen Crna mačka, beli mačor, den bästa filmen i der världshistorien, ich lovar?"
    ...
    br "-Jetzt geht es los, kung Simon!!"
    ...
    br "-Din frågenfarenvaren bist eine schimäre."

    g "-..."

    br "-Nun werden Sie falsch antworten und jeder wird Sie auslachen?"
    ...
    f "-Jaa! Jag är här! Är det jag?! Förresten! har du tänkt på hur vi kanske inte kan se färg på riktigt utan bara i RGB-rymden enligt J. Beskows teore..."
    ...
    vic "-Jag har glömt att spela in IDOOOOOOL!!!"
    ...
    b "Han granskade Vidar från topp till tå med en skeptisk min."

    g "-Och den där mustachen, den får du abraken."
